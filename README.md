...
- The detected token addresses are saved in a local SQLite database to avoid duplicate purchases. No additional setup or configuration is required, the database is automatically created in the working directory.
